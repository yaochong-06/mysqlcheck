...
from doc import get_mysql_doc_linux, get_mysql_doc_remote_win, \
...
def get_server_info(company_name, engineer_name, customer_name, customer_name2):
    ...
    for line in res:
        if not line.startswith('#'):
            ...
            # Linux平台远程
            if len(info_list) == 9 and info_list[5] == 'Linux':
                get_mysql_doc_linux(company_name, engineer_name, customer_name, customer_name2, (info_list[0],
                                                                                                 info_list[1],
                                                                                                 info_list[2],
                                                                                                 info_list[3],
                                                                                                 info_list[4],
